...
$tokens-map: (
  ...
  'color-background-overlay': (rgba(71, 77, 102, 0.64)),
  ...
  'color-border-primary-strongest': (rgb(12, 30, 86)),
  ...
  'shadow-focus-shadow-border': (0 0 0 1px #cacdd8, 0 0 0 3px #ffffff, 0 0 0 4px #006dfa, 0 0 0 6px #cce4ff),
  ...
  /* Destructive text. */
  'color-text-destructive': (rgb(199, 35, 35)),
  /* Primary text. */
  ...
  'color-text-icon-brand-highlight': (rgb(82, 189, 148)),
