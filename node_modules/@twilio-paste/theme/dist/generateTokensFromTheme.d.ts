...
export declare const generateTokensFromTheme: ({ backgroundColors, borderColors, borderWidths, colorSchemes, radii, fonts, fontSizes, fontWeights, lineHeights, shadows, sizes, space, textColors, zIndices, dataVisualization, }: GenerateTokensFromTheme) => Partial<GenericTokensShape>;
export {};
